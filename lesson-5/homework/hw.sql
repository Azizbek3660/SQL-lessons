...
SELECT TOP (1000) [Salary] ,[Age]
     
  FROM [master].[dbo].[Employees]
  WHERE AGE < 25 AND SALARY>60000

12-Update the salary of an employees based on their department, increase by 10% if they work in 'HR' or EmployeeID = 5
...
CREATE TABLE Orders ( OrderID INT PRIMARY KEY, CustomerID INT, ProductID INT, OrderDate DATE, Quantity INT, TotalAmount DECIMAL(10))
