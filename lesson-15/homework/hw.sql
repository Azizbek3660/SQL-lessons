...
select departments.id,employees.name from departments
join employees
...
select id, product_name, price as max_price from products
...
(3, 'Olivia', 40000, 2),
(4, 'Paul', 55000, 2);
select id, name, salary as avg_max_salary from employees
...
AND e.salary < dept_max.max_dept_salary;
